...
tellraw @s ["",{"text":"\n      > ","color":"red","clickEvent":{"action":"run_command","value":"/tag @s add Glib_Menu_Cache_Ghost"},"hoverEvent":{"action":"show_text","value":"Define the position of cache allowing to store data in some object (Armor Stand, Sign, Command Block, Jukebox, Chest, Shulker Box and Structure Block). Mandatory for some systems."}},{"text":"Define cache position","color":"gray","clickEvent":{"action":"run_command","value":"/tag @s add Glib_Menu_Cache_Ghost"},"hoverEvent":{"action":"show_text","value":"Define the position of cache allowing to store data in some object (Armor Stand, Sign, Command Block, Jukebox, Chest and Shulker Box). Mandatory for some systems."}}]
tellraw @s ["",{"text":"\n      > ","color":"red","clickEvent":{"action":"run_command","value":"/tag @s add Glib_Menu_Structure_config"},"hoverEvent":{"action":"show_text","value":"Save StructureBlocks settings and trigger them anywhere in your world"}},{"text":"Structure Settings","color":"gray","clickEvent":{"action":"run_command","value":"/tag @s add Glib_Menu_Structure_config"},"hoverEvent":{"action":"show_text","value":"Save StructureBlocks settings and trigger them anywhere in your world"}}]
...
execute as @s[tag=Glib_Menu_Structure_config] at @s run function gunivers-lib:core/menu/creator/structures/structure_main_menu
